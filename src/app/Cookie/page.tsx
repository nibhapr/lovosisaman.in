        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-3 text-gray-600">
              <li>
                <span className="font-semibold">Essential Cookies:</span> Required for the website to function properly, including authentication and security.
              </li>
              <li>
                <span className="font-semibold">Performance Cookies:</span> Help us understand how visitors interact with our website by collecting anonymous information.
              </li>
              <li>
                <span className="font-semibold">Functionality Cookies:</span> Remember your preferences and choices to enhance your browsing experience.
              </li>
              <li>
                <span className="font-semibold">Marketing Cookies:</span> Used to track visitors across websites to display relevant advertisements.
              </li>
            </ul>
          </section>
