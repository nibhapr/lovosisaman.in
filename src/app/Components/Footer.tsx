        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-[#E4405F] transition-colors duration-300">
                <FontAwesomeIcon icon={faInstagram} className="h-8 w-8" />
              </a>
              <a href="#" className="text-gray-400 hover:text-[#000000] transition-colors duration-300">
                <FontAwesomeIcon icon={faThreads} className="h-8 w-8" />
              </a>
              <a href="#" className="text-gray-400 hover:text-[#0A66C2] transition-colors duration-300">
